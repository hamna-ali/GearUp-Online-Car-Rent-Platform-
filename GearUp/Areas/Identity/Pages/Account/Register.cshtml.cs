...
namespace GearUp.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Add claim "Permission" = "UserAccess"
                    var claim = new Claim("Permission", "UserAccess");
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            if (_userStore is not IUserEmailStore<ApplicationUser> emailStore)
            {
                throw new InvalidOperationException("The user store does not support email.");
            }
